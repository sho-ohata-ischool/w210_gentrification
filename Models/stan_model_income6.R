...
df_forecast <- df_forecast[order(Year,ZIP)]
...
pred_out <- pred_out[pred_out$y_sim < 1.5,]
MAPE_stan <- sum(abs(pred_out$y_sim - pred_out$ZillowAdj2)/pred_out$ZillowAdj2)/dim(pred_out)[1] ##11.6%
